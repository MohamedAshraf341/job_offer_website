...
namespace jobs_offer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            //var db = new DB();
            //IEnumerable<SelectListItem> UserType = db.UserType.Select(b => new SelectListItem { Value = b.UserType, Text = b.UserType });
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                //var db = new DB();
                //db.RegisterViewModel.InsertOnSubmit(model);
                //db.SubmitChanges();
        ...
        public ActionResult Editprofile(EditprofileViewModel profile)
        {
            ...
            {
                ViewBag.Message = "كلمة السر الحالية غير صحيحه";
            }
            else
            {
                ...
                db.SaveChanges();
                ViewBag.Message = "تمت عملية التحديث ";
